  ...
  <div class="mobile-header-active mobile-header-wrapper-style">
    <div class="clickalbe-sidebar-wrap">
      ...
      <div class="mobile-header-content-area">
        <div
          class="header-offer-wrap-2 mrg-none mobile-header-padding-border-4"
        >
        ...
        <div
          class="
            main-categori-wrap
            mobile-menu-wrap mobile-header-padding-border-3
          "
        >
          <a class="categori-show" href="#">
            <i class="lnr lnr-menu"></i> All Department
            <i class="icon-arrow-down icon-right"></i>
          </a>
                  ...
                  <ul class="dropdown">
                    ...
                    <li class="menu-item-has-children">
                      ...
                      <ul class="dropdown">
                        ...
                        <li>
                          <a href="product-details-2.html">Occasion Gowns</a>
                        </li>
                        <li>
        ...
        <div class="mobile-header-info-wrap mobile-header-padding-border-3">
          <div class="single-mobile-header-info">
            <a href="store-location.html"
              ><i class="lastudioicon-pin-3-2"></i> Store Location
            </a>
          </div>
          <div class="single-mobile-header-info">
        ...
        <div class="mobile-contact-info mobile-header-padding-border-4">
          <ul>
            ...
            <li>
              <i class="icon-home"></i> PO Box 1622 Colins Street West Australia
            </li>
          </ul>
        </div>
